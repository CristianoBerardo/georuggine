...
All'avvio, in [main.rs](client/src/main.rs), il client attraversa questi passaggi — tutti racchiusi in un `loop` che riparte da capo se l'utente elimina il proprio account, invece di terminare il processo:
...
| [`ui/mod.rs`](client/src/ui/mod.rs)                                         | Dichiara i sottomoduli `auth_ui`, `main_ui`, `terminal_guard`.                                                                                                                                                                                                                 |
